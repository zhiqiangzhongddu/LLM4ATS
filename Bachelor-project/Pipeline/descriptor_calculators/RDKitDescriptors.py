...
def calc_RDKit_desc(mol, desc_name_list): 
    ...
    Descriptors_lst = ["HeavyAtomMolWt", "NOCount", "NumValenceElectrons", "ExactMolWT"]
    LipinskiDes = ["Heavy Atom Count", "NHOH group count", "NO group count", "NumHAcceptors", "NumHDonors", "NumHeteroatoms", "NumRotatableBonds",  "RingCount", "NumAromaticRings"]
    ...
    list_of_uncalc_desc = ["Topliss fragments", "FractionCSP3", "NumAmideBonds", "NumBridgeheadAtoms", "BCUT2D", "NumAliphaticRings", "NumSaturatedRings", "MQNs", "Autocorr2D", "NumSpiroAtoms", "Phi", "MolWT"]
