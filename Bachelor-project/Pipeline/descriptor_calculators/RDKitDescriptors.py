...
def calc_RDKit_desc(mol, desc_name_list): 
    ...
    list_of_uncalc_desc = ["Topliss fragments", "FractionCSP3", "NumAmideBonds", "NumBridgeheadAtoms", "BCUT2D", "NumAromaticRings", "NumAliphaticRings", "NumSaturatedRings", "MQNs", "Autocorr2D", "NumSpiroAtoms", "Phi", "MolWT"]
