...
def set_cfg(cfg):
    ...
    cfg.gnn.model.num_layers = 2#4
    # Hidden size of the model
    cfg.gnn.model.hidden_dim = 700#128
    ...
    # Base learning rate
    cfg.gnn.train.lr = 10#PEMP: 10 default: 1e-3
    # Dropout rate
    cfg.gnn.train.dropout = 0.2 #PEMP: 0.2, 0.1, 0.05 default: 0.0
    # The weight decay to apply (if not zero) to all layers except all bias and LayerNorm weights
    cfg.gnn.train.weight_decay = 0.0
    # Maximal number of epochs
    cfg.gnn.train.epochs = 10 #200
